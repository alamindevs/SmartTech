    ...
    <div class="row justify-content-center">
        <div class="col-10">
            <div class="card">
                ...
                <form action="{{ route('admin.option.update', $option->id) }}" method="post" id="update-form" class="form-horizontal form-wizard-wrapper">
                    <div class="card-body">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-check-inline my-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="is_required" class="custom-control-input" id="customCheck" {{ $option->is_required == 1 ? 'checked' : ''}}>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.option.index') }}" class="btn btn-info waves-effect waves-light">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
