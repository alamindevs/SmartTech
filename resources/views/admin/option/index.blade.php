        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right" href="{{ route('admin.option.create') }}"><i class="mdi mdi-plus-circle-outline"></i> Create Brand</a>
...
{{-- button use  --}}
    ...
    <script>
    	$("#datatable").DataTable({
    		serverSide: true,
    		ajax: "{{ route('admin.option.dataTable') }}",
    		columns: [
    		{ name: 'name' },
            { name: 'type' },
