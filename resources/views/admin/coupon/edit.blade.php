    ...
    <div class="row justify-content-center">
        <div class="col-10">
            <div class="card">
                ...
                <form action="{{ route('admin.coupon.update', $coupon->id) }}" method="post" id="update-form" class="form-horizontal form-wizard-wrapper">
                   @csrf
                   @method('put')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.coupon.index') }}" class="btn btn-info waves-effect waves-light">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
