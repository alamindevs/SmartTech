        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right" href="{{ route('admin.attribute.create') }}"><i class="mdi mdi-plus-circle-outline"></i> Create Attribute</a>
...
{{-- button use  --}}
    ...
    <script>
    	$("#datatable").DataTable({
    		serverSide: true,
    		ajax: "{{ route('admin.attribute.dataTable') }}",
    		columns: [
    		{ name: 'name' },
