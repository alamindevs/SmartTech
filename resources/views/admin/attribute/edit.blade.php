        ...
        <div class="col-10">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right" href="{{ route('admin.attribute.index') }}"><i class="mdi mdi-arrow-left-thick"></i> Back</a>
                </div>
                    
                <form action="{{ route('admin.attribute.update', $attribute->id) }}" method="post" id="update-form" class="form-horizontal form-wizard-wrapper">
                    <div class="card-body">
                        @csrf
                        @method('put')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.attribute.index') }}" class="btn btn-info waves-effect waves-light">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
