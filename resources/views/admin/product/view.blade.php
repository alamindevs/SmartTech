                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="single-pro-detail">
                                ...
                                @if($product->special_price_end > now())
                                    <h2 class="pro-price">Tk {{ $product->special_price }} <span><del>Tk {{ $product->price }}</del></span><small class="text-danger font-weight-bold ml-2">{{$product->getOffer()}}% Off</small></h2>
                                @else
                                    <h2 class="pro-price">Tk {{ $product->getSellingPrice() }}</h2>
                                @endif
