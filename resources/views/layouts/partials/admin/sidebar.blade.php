<div class="left-sidenav">
    <div class="main-icon-menu">
        <nav class="nav">
            ...
            <!--end MetricaCrypto-->
            <a href="#MetricaMidea" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="Midea">
                <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <div class="main-menu-inner">
        <div class="menu-body slimscroll">
            ...
            <!-- end Crypto -->
            <div id="MetricaMidea" class="main-icon-menu-pane">
                <div class="title-box">
                    <h6 class="menu-title">Midea</h6></div>
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.midea.index') }}"><i class="dripicons-camera"></i>Midea</a></li>
                </ul>
            </div>
            <!-- end  Project-->
            ...
            <div id="MetricaAuthentication" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.users.index') }}"><i class="dripicons-user"></i>Users</a></li>
                    <li class="nav-item"><a class="nav-link" href="../authentication/auth-register.html"><i class="dripicons-user-group"></i>Customars</a></li>
                    <li class="nav-item"><a class="nav-link" href="../authentication/auth-recover-pw.html"><i class="dripicons-user-id"></i>Roles</a></li>
                    <li class="nav-item"><a class="nav-link" href="../authentication/auth-lock-screen.html"><i class="dripicons-power"></i>LogOut</a></li>
                </ul>
            </div>
            <!-- end Authentication-->
        </div>
